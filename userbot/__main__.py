...
if Config.ENABLE_ASSISTANTBOT == "ENABLE":
    ...
    sed.info("║┣⪼ Ⲟⲱⲛⲉʀ - 𝙧𝙮𝙩𝙧𝙚𝙨𝙝-𝙪𝙨𝙚𝙧𝙗𝙤𝙩 ")
    ...
    sed.info("║┣⪼ ✨𝙉𝙖𝙧𝙚𝙨𝙝-𝙐𝙎𝙀𝙍𝘽𝙊𝙏✨")
    sed.info("║╰━━━━━━━━━━━━━━━➣ ")
    sed.info("╚══════════════════❍⊱❁۪۪")
else:
    sed.info("Naresh-USERBOT Has Been Installed Sucessfully !")
    sed.info("You Can Visit @nrzzxx For Any Support Or Doubts")
